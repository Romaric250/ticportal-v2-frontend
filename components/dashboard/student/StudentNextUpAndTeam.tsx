  ...
  return (
    <>
      <div className="flex flex-col gap-2 text-xs font-semibold text-slate-800 sm:flex-row sm:items-center sm:justify-between">
        ...
        <button className="text-left text-[11px] font-medium text-[#111827] hover:underline sm:text-center">
          View all modules
        </button>
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,2fr)_minmax(0,1.1fr)]">
        ...
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
          <div className="grid gap-4 md:grid-cols-[220px,minmax(0,1fr)]">
            <div className="relative h-32 rounded-xl bg-slate-100 sm:h-40">
              <span className="absolute left-3 top-3 rounded-full bg-white px-3 py-1 text-[10px] font-semibold uppercase tracking-wide text-slate-700 shadow-sm">
                Academic
              </span>
            </div>
        ...
        {/* Team card */}
        <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
          <div className="flex h-full flex-col justify-between gap-3 rounded-xl bg-slate-50 px-4 py-4 text-xs">
            ...
            <div className="flex flex-col items-start justify-between gap-3 sm:flex-row sm:items-center">
              <div className="flex items-center -space-x-3">
                ...
                <span className="flex h-10 w-10 items-center justify-center rounded-full bg-white text-[11px] font-semibold text-slate-600 shadow-sm sm:h-12 sm:w-12">
                  +2
                </span>
              </div>
              <div className="flex flex-row gap-2 text-[10px] sm:flex-col">
