          ...
          <div className="p-2">
            <div className="mb-2 rounded-lg bg-slate-50 p-2">
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 rounded-full bg-gradient-to-br from-[#111827] to-slate-500 flex items-center justify-center text-white text-xs font-semibold flex-shrink-0">
                  {user?.name?.charAt(0).toUpperCase() || "U"}
                </div>
            ...
            <div className="space-y-0.5">
              <button className="cursor-pointer flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-xs text-slate-700 hover:bg-slate-50">
              ...
              <button
                ...
                className="cursor-pointer flex w-full items-center gap-2 rounded-lg px-2 py-1.5 text-xs text-red-600 hover:bg-red-50"
              >
                <LogOut size={14} />
                <span>Sign Out</span>
              </button>
